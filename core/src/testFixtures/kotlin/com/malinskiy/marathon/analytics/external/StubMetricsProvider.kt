...
class StubMetricsProvider(
    ...
    override fun successRate(test: Test, limit: Instant): Double = successRates[test] ?: successRate

    override fun executionTime(test: Test, percentile: Double, limit: Instant): Double = executionTimes[test] ?: executionTime
